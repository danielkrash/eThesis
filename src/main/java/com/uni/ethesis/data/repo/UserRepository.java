...
public interface UserRepository extends JpaRepository<User, UUID> , JpaSpecificationExecutor<User> {
    ...
    //Users who were ever a department head (had any appointment)
    @Query("SELECT DISTINCT u FROM User u JOIN u.appointments app")
    List<User> findUsersWithAnyDepartmentAppointment();

    //Users who were department head from a specific start date to a specific end date (appointment overlaps the range)
    ...
    //Users who were department head of a specific department (by department name)
    ...
    //Users who were department head of a specific department (by department id)
    ...
    //Users who currently are department head of a specific department (by department name)
    ...
    //Users who currently are department head of a specific department (by department id)
